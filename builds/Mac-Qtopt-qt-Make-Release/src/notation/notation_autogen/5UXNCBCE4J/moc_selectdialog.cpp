...
struct qt_meta_stringdata_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS = QtMocHelpers::stringData(
    "mu::notation::SelectDialog",
    "buttonClicked",
    "",
    "QAbstractButton*",
    "button"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::notation::SelectDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *mu::notation::SelectDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEnotationSCOPESelectDialogENDCLASS.stringdata0))
