...
public:
    ...
    muse::uicomponents::RadioButtonGroupBox *chromaticBox;
    QVBoxLayout *verticalLayout_3;
    muse::uicomponents::RadioButtonGroupBox *transposeByKey;
    QGridLayout *gridLayout;
    QComboBox *keyList;
    QRadioButton *upKey;
    QRadioButton *downKey;
    QRadioButton *closestKey;
    muse::uicomponents::RadioButtonGroupBox *transposeByInterval;
    QGridLayout *gridLayout_2;
    QRadioButton *upInterval;
    QComboBox *intervalList;
    QRadioButton *downInterval;
    QCheckBox *transposeKeys;
    muse::uicomponents::RadioButtonGroupBox *diatonicBox;
    ...
    void setupUi(QDialog *TransposeDialogBase)
    {
        if (TransposeDialogBase->objectName().isEmpty())
            TransposeDialogBase->setObjectName("TransposeDialogBase");
        ...
        chromaticBox = new muse::uicomponents::RadioButtonGroupBox(widget);
        chromaticBox->setObjectName("chromaticBox");
        chromaticBox->setCheckable(true);
        verticalLayout_3 = new QVBoxLayout(chromaticBox);
        verticalLayout_3->setObjectName("verticalLayout_3");
        transposeByKey = new muse::uicomponents::RadioButtonGroupBox(chromaticBox);
        transposeByKey->setObjectName("transposeByKey");
        ...
        transposeByInterval = new muse::uicomponents::RadioButtonGroupBox(chromaticBox);
        transposeByInterval->setObjectName("transposeByInterval");
        ...
        upInterval->setObjectName("upInterval");
        ...
        transposeKeys->setObjectName("transposeKeys");
        ...
        diatonicBox = new muse::uicomponents::RadioButtonGroupBox(widget);
        diatonicBox->setObjectName("diatonicBox");
        ...
        upDiatonic->setObjectName("upDiatonic");
        ...
        transposeChordNames->setObjectName("transposeChordNames");
        ...
        accidentalOptions->addItem(QString());
        accidentalOptions->setObjectName("accidentalOptions");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, TransposeDialogBase, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, TransposeDialogBase, qOverload<>(&QDialog::reject));
