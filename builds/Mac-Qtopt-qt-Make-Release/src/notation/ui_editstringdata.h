...
public:
    ...
    void setupUi(QDialog *EditStringDataBase)
    {
        if (EditStringDataBase->objectName().isEmpty())
            EditStringDataBase->setObjectName("EditStringDataBase");
        ...
        stringList->setObjectName("stringList");
        ...
        numOfFrets->setObjectName("numOfFrets");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, EditStringDataBase, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, EditStringDataBase, qOverload<>(&QDialog::reject));
