...
public:
    ...
    void setupUi(QDialog *MeasurePropertiesBase)
    {
        if (MeasurePropertiesBase->objectName().isEmpty())
            MeasurePropertiesBase->setObjectName("MeasurePropertiesBase");
        ...
        nominalZ->setObjectName("nominalZ");
        ...
        irregular->setObjectName("irregular");

        gridLayout1->addWidget(irregular, 0, 0, 1, 2);

        breakMultiMeasureRest = new QCheckBox(groupBox_2);
        breakMultiMeasureRest->setObjectName("breakMultiMeasureRest");
        ...
        layoutStretch->setObjectName("layoutStretch");
        ...
        measureNumberOffset->setObjectName("measureNumberOffset");
        ...
        measureNumberMode->addItem(QString());
        measureNumberMode->addItem(QString());
        measureNumberMode->setObjectName("measureNumberMode");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, MeasurePropertiesBase, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, MeasurePropertiesBase, qOverload<>(&QDialog::reject));
