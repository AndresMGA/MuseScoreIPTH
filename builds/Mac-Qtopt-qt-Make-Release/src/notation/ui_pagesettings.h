...
public:
    ...
    void setupUi(QDialog *PageSettingsBase)
    {
        if (PageSettingsBase->objectName().isEmpty())
            PageSettingsBase->setObjectName("PageSettingsBase");
        ...
        resetPageStyleButton->setObjectName("resetPageStyleButton");
        ...
        buttonApplyToAllParts->setObjectName("buttonApplyToAllParts");
        ...
        spatiumEntry->setObjectName("spatiumEntry");
        ...
        inchButton->setObjectName("inchButton");
        ...
        oddPageLeftMargin->setObjectName("oddPageLeftMargin");
        ...
        oddPageRightMargin->setObjectName("oddPageRightMargin");
        ...
        oddPageBottomMargin->setObjectName("oddPageBottomMargin");
        ...
        oddPageTopMargin->setObjectName("oddPageTopMargin");
        ...
        evenPageRightMargin->setObjectName("evenPageRightMargin");
        ...
        evenPageBottomMargin->setObjectName("evenPageBottomMargin");
        ...
        evenPageLeftMargin->setObjectName("evenPageLeftMargin");
        ...
        evenPageTopMargin->setObjectName("evenPageTopMargin");
        ...
        pageOffsetEntry->setObjectName("pageOffsetEntry");
