...
public:
    ...
    void setupUi(QGroupBox *NoteGroups)
    {
        if (NoteGroups->objectName().isEmpty())
            NoteGroups->setObjectName("NoteGroups");
        ...
        iconPalette->setObjectName("iconPalette");
        ...
        changeShorterCheckBox->setObjectName("changeShorterCheckBox");
        ...
        resetGroups->setObjectName("resetGroups");
