...
struct qt_meta_stringdata_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS = QtMocHelpers::stringData(
    "mu::palette::NoteGroupsExampleView",
    "noteClicked",
    "",
    "engraving::Note*",
    "beamPropertyDropped",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::palette::NoteGroupsExampleView::staticMetaObject = { {
    QMetaObject::SuperData::link<notation::ExampleView::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NoteGroupsExampleView, std::true_type>,
        // method 'noteClicked'
...
void mu::palette::NoteGroupsExampleView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->noteClicked((*reinterpret_cast< std::add_pointer_t<engraving::Note*>>(_a[1]))); break;
        case 1: _t->beamPropertyDropped((*reinterpret_cast< std::add_pointer_t<engraving::Chord*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<engraving::ActionIcon*>>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &NoteGroupsExampleView::noteClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &NoteGroupsExampleView::beamPropertyDropped; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *mu::palette::NoteGroupsExampleView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEpaletteSCOPENoteGroupsExampleViewENDCLASS.stringdata0))
