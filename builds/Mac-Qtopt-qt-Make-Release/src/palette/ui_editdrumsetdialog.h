...
public:
    ...
    void setupUi(QDialog *EditDrumsetDialog)
    {
        if (EditDrumsetDialog->objectName().isEmpty())
            EditDrumsetDialog->setObjectName("EditDrumsetDialog");
        ...
        pitchList->setObjectName("pitchList");
        ...
        customGbox->setObjectName("customGbox");
        ...
        drumNote->setObjectName("drumNote");
        ...
        staffLine->setObjectName("staffLine");
        ...
        stemDirection->addItem(QString());
        stemDirection->addItem(QString());
        stemDirection->setObjectName("stemDirection");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, EditDrumsetDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, EditDrumsetDialog, qOverload<>(&QDialog::reject));
