...
struct qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::engraving::apiv1::MStyle::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MStyle, std::true_type>,
        // method 'value'
...
void *mu::engraving::apiv1::MStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEMStyleENDCLASS.stringdata0))
