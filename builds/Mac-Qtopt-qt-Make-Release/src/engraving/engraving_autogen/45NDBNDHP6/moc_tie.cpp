...
#include "../../../../../../src/engraving/api/v1/tie.h"
...
struct qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::engraving::apiv1::Tie::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS_t,
        // property 'startNote'
        QtPrivate::TypeAndForceComplete<apiv1::Note*, std::true_type>,
        // property 'endNote'
        QtPrivate::TypeAndForceComplete<apiv1::Note*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Tie, std::true_type>
    >,
    nullptr
} };
...
void *mu::engraving::apiv1::Tie::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPETieENDCLASS.stringdata0))
