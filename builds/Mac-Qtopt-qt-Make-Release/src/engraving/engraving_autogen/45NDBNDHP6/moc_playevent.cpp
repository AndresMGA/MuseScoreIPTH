...
struct qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::engraving::apiv1::PlayEvent::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS_t,
        // property 'pitch'
        ...
        QtPrivate::TypeAndForceComplete<int, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PlayEvent, std::true_type>
    >,
    nullptr
} };
...
void *mu::engraving::apiv1::PlayEvent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEengravingSCOPEapiv1SCOPEPlayEventENDCLASS.stringdata0))
