...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::TimeSignatureSettingsModel",
    "showTimeSignatureProperties",
    "",
    "horizontalScale",
    "PropertyItem*",
    "verticalScale",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::TimeSignatureSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TimeSignatureSettingsModel, std::true_type>,
        // method 'showTimeSignatureProperties'
...
void *mu::inspector::TimeSignatureSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETimeSignatureSettingsModelENDCLASS.stringdata0))
