...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::SpacerSettingsModel",
    "spacerHeight",
    "PropertyItem*"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::SpacerSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS_t,
        // property 'spacerHeight'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SpacerSettingsModel, std::true_type>
    >,
    nullptr
} };
...
void *mu::inspector::SpacerSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESpacerSettingsModelENDCLASS.stringdata0))
