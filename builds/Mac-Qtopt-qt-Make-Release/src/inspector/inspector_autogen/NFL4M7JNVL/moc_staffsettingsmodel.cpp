...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::StaffSettingsModel",
    "barlinesSpanFrom",
    "PropertyItem*",
    "barlinesSpanTo"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::StaffSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS_t,
        // property 'barlinesSpanFrom'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'barlinesSpanTo'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
...
void *mu::inspector::StaffSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEStaffSettingsModelENDCLASS.stringdata0))
