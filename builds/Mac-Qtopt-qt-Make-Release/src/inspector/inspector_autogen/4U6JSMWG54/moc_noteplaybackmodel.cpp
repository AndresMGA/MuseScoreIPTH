...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::NotePlaybackModel",
    "tuning",
    "PropertyItem*",
    "velocity"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::NotePlaybackModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS_t,
        // property 'tuning'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'velocity'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NotePlaybackModel, std::true_type>
    >,
    nullptr
} };
...
void *mu::inspector::NotePlaybackModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPENotePlaybackModelENDCLASS.stringdata0))
