...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::TextFrameSettingsModel",
    "gapAbove",
    "PropertyItem*",
    "gapBelow",
    "frameLeftMargin",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::TextFrameSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS_t,
        // property 'gapAbove'
        ...
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TextFrameSettingsModel, std::true_type>
    >,
    nullptr
} };
...
void *mu::inspector::TextFrameSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPETextFrameSettingsModelENDCLASS.stringdata0))
