...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::SectionBreakSettingsModel",
    "shouldStartWithLongInstrNames",
    "PropertyItem*",
    "shouldResetBarNums",
    "pauseDuration",
    "firstSystemIndent"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::SectionBreakSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS_t,
        // property 'shouldStartWithLongInstrNames'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'shouldResetBarNums'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'pauseDuration'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'firstSystemIndent'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SectionBreakSettingsModel, std::true_type>
    >,
    nullptr
} };
...
void mu::inspector::SectionBreakSettingsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        case 3: *reinterpret_cast< PropertyItem**>(_v) = _t->firstSystemIndent(); break;
        default: break;
        }
...
void *mu::inspector::SectionBreakSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPESectionBreakSettingsModelENDCLASS.stringdata0))
