...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::VoltaSettingsModel",
    "repeatCount",
    "PropertyItem*"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::VoltaSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<TextLineSettingsModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS_t,
        // property 'repeatCount'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<VoltaSettingsModel, std::true_type>
    >,
    nullptr
} };
...
void *mu::inspector::VoltaSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEVoltaSettingsModelENDCLASS.stringdata0))
