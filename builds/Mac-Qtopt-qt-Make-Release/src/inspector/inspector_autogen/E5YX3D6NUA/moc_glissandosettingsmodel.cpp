...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::GlissandoSettingsModel",
    "possibleLineTypes",
    "",
    "lineType",
    "PropertyItem*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       1,    0,   20,    2, 0x102,    4 /* Public | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject mu::inspector::GlissandoSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS_t,
        // property 'lineType'
        ...
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<GlissandoSettingsModel, std::true_type>,
...
void *mu::inspector::GlissandoSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEGlissandoSettingsModelENDCLASS.stringdata0))
