...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::OttavaSettingsModel",
    "possibleOttavaTypes",
    "",
    "ottavaType",
    "PropertyItem*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::OttavaSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<TextLineSettingsModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS_t,
        // property 'ottavaType'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'showNumbersOnly'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OttavaSettingsModel, std::true_type>,
        // method 'possibleOttavaTypes'
...
void *mu::inspector::OttavaSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEOttavaSettingsModelENDCLASS.stringdata0))
