...
struct qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS = QtMocHelpers::stringData(
    "mu::inspector::BeamModesModel",
    "createProperties",
    "",
    "requestElements",
    "loadProperties",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject mu::inspector::BeamModesModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS_t,
        // property 'mode'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // property 'isFeatheringAvailable'
        QtPrivate::TypeAndForceComplete<PropertyItem*, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<BeamModesModel, std::true_type>,
...
void *mu::inspector::BeamModesModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSmuSCOPEinspectorSCOPEBeamModesModelENDCLASS.stringdata0))
