...
constexpr auto qt_meta_stringdata_CLASSKDDockWidgetsSCOPEWidgetResizeHandlerENDCLASS = QtMocHelpers::stringData(
...
constexpr auto qt_meta_stringdata_CLASSKDDockWidgetsSCOPECustomFrameHelperENDCLASS = QtMocHelpers::stringData(
