...
constexpr auto qt_meta_stringdata_CLASSKDDockWidgetsSCOPETabWidgetQuickENDCLASS = QtMocHelpers::stringData(
...
constexpr auto qt_meta_stringdata_CLASSKDDockWidgetsSCOPEDockWidgetModelENDCLASS = QtMocHelpers::stringData(
