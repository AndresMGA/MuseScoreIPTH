...
struct qt_meta_stringdata_mu__notation__BeamsPageModel_t {
    QByteArrayData data[6];
    char stringdata0[86];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__notation__BeamsPageModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__notation__BeamsPageModel_t qt_meta_stringdata_mu__notation__BeamsPageModel = {
    {
QT_MOC_LITERAL(0, 0, 28), // "mu::notation::BeamsPageModel"
QT_MOC_LITERAL(1, 29, 12), // "useWideBeams"
QT_MOC_LITERAL(2, 42, 10), // "StyleItem*"
QT_MOC_LITERAL(3, 53, 9), // "beamWidth"
QT_MOC_LITERAL(4, 63, 10), // "beamMinLen"
QT_MOC_LITERAL(5, 74, 11) // "beamNoSlope"

    },
    "mu::notation::BeamsPageModel\0useWideBeams\0"
    "StyleItem*\0beamWidth\0beamMinLen\0"
    "beamNoSlope"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__notation__BeamsPageModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::notation::BeamsPageModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractStyleDialogModel::staticMetaObject>(),
    qt_meta_stringdata_mu__notation__BeamsPageModel.data,
    qt_meta_data_mu__notation__BeamsPageModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::notation::BeamsPageModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__notation__BeamsPageModel.stringdata0))
