...
struct qt_meta_stringdata_mu__notation__BendStyleSelector_t {
    QByteArrayData data[3];
    char stringdata0[51];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__notation__BendStyleSelector_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__notation__BendStyleSelector_t qt_meta_stringdata_mu__notation__BendStyleSelector = {
    {
QT_MOC_LITERAL(0, 0, 31), // "mu::notation::BendStyleSelector"
QT_MOC_LITERAL(1, 32, 7), // "useFull"
QT_MOC_LITERAL(2, 40, 10) // "StyleItem*"

    },
    "mu::notation::BendStyleSelector\0useFull\0"
    "StyleItem*"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__notation__BendStyleSelector[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::notation::BendStyleSelector::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractStyleDialogModel::staticMetaObject>(),
    qt_meta_stringdata_mu__notation__BendStyleSelector.data,
    qt_meta_data_mu__notation__BendStyleSelector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::notation::BendStyleSelector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__notation__BendStyleSelector.stringdata0))
