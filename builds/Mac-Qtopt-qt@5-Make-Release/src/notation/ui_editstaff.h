...
public:
    ...
    void setupUi(QDialog *EditStaffBase)
    {
        if (EditStaffBase->objectName().isEmpty())
            EditStaffBase->setObjectName(QString::fromUtf8("EditStaffBase"));
        ...
        groupStaffProps->setObjectName(QString::fromUtf8("groupStaffProps"));
        ...
        grid_StaffProps->setObjectName(QString::fromUtf8("grid_StaffProps"));
        ...
        hideMode->addItem(QString());
        hideMode->addItem(QString());
        hideMode->setObjectName(QString::fromUtf8("hideMode"));
        ...
        hLayout_LineColor->setObjectName(QString::fromUtf8("hLayout_LineColor"));
        ...
        hideSystemBarLine->setObjectName(QString::fromUtf8("hideSystemBarLine"));

        grid_StaffProps->addWidget(hideSystemBarLine, 4, 2, 1, 1);

        cutaway = new QCheckBox(groupStaffProps);
        cutaway->setObjectName(QString::fromUtf8("cutaway"));
        ...
        mergeMatchingRests->setObjectName(QString::fromUtf8("mergeMatchingRests"));

        grid_StaffProps->addWidget(mergeMatchingRests, 5, 2, 1, 1);

        isSmallCheckbox = new QCheckBox(groupStaffProps);
        isSmallCheckbox->setObjectName(QString::fromUtf8("isSmallCheckbox"));
        ...
        staffGroupName->setObjectName(QString::fromUtf8("staffGroupName"));

        formLayout->setWidget(0, QFormLayout::FieldRole, staffGroupName);

        labelNumOfLines = new QLabel(groupStaffProps);
        labelNumOfLines->setObjectName(QString::fromUtf8("labelNumOfLines"));
        ...
        labelLineDist->setObjectName(QString::fromUtf8("labelLineDist"));
        ...
        labelExtraDist->setObjectName(QString::fromUtf8("labelExtraDist"));

        formLayout->setWidget(4, QFormLayout::LabelRole, labelExtraDist);

        spinExtraDistance = new QDoubleSpinBox(groupStaffProps);
        spinExtraDistance->setObjectName(QString::fromUtf8("spinExtraDistance"));
        ...
        labelStaffGroup->setObjectName(QString::fromUtf8("labelStaffGroup"));
        ...
        changeStaffType->setObjectName(QString::fromUtf8("changeStaffType"));
        ...
        groupPartProps->setObjectName(QString::fromUtf8("groupPartProps"));
        ...
        grid_PartProps->setObjectName(QString::fromUtf8("grid_PartProps"));
        ...
        changeInstrument->setObjectName(QString::fromUtf8("changeInstrument"));
        ...
        labelInstrName->setObjectName(QString::fromUtf8("labelInstrName"));
        ...
        grid_InstrNames->setObjectName(QString::fromUtf8("grid_InstrNames"));
        labelLongName = new QLabel(groupPartProps);
        labelLongName->setObjectName(QString::fromUtf8("labelLongName"));
        ...
        longName->setObjectName(QString::fromUtf8("longName"));
        ...
        shortName->setObjectName(QString::fromUtf8("shortName"));
        ...
        labelPitchRanges->setObjectName(QString::fromUtf8("labelPitchRanges"));

        verticalLayout->addWidget(labelPitchRanges);

        hLayout_PitchRanges = new QHBoxLayout();
        hLayout_PitchRanges->setObjectName(QString::fromUtf8("hLayout_PitchRanges"));
        ...
        minPitchA->setObjectName(QString::fromUtf8("minPitchA"));
        ...
        minPitchASelect->setObjectName(QString::fromUtf8("minPitchASelect"));
        ...
        maxPitchA->setObjectName(QString::fromUtf8("maxPitchA"));
        ...
        maxPitchASelect->setObjectName(QString::fromUtf8("maxPitchASelect"));
        ...
        minPitchP->setObjectName(QString::fromUtf8("minPitchP"));
        ...
        minPitchPSelect->setObjectName(QString::fromUtf8("minPitchPSelect"));
        ...
        maxPitchP->setObjectName(QString::fromUtf8("maxPitchP"));
        ...
        maxPitchPSelect->setObjectName(QString::fromUtf8("maxPitchPSelect"));
        ...
        vLayout_Transposition->setObjectName(QString::fromUtf8("vLayout_Transposition"));
        transp_Main = new QHBoxLayout();
        transp_Main->setObjectName(QString::fromUtf8("transp_Main"));
        labelTransp = new QLabel(groupPartProps);
        labelTransp->setObjectName(QString::fromUtf8("labelTransp"));
        ...
        iList->addItem(QString());
        iList->addItem(QString());
        iList->setObjectName(QString::fromUtf8("iList"));
        ...
        horizontalSpacer_1 = new QSpacerItem(17, 18, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        transp_PreferSharpFlat->setObjectName(QString::fromUtf8("transp_PreferSharpFlat"));
        transp_PreferSharpFlat_Layout = new QHBoxLayout(transp_PreferSharpFlat);
        transp_PreferSharpFlat_Layout->setSpacing(6);
        transp_PreferSharpFlat_Layout->setObjectName(QString::fromUtf8("transp_PreferSharpFlat_Layout"));
        transp_PreferSharpFlat_Layout->setContentsMargins(0, 0, 0, 0);
        labelPreferSharpFlat = new QLabel(transp_PreferSharpFlat);
        labelPreferSharpFlat->setObjectName(QString::fromUtf8("labelPreferSharpFlat"));
        ...
        preferSharpFlat->addItem(QString());
        preferSharpFlat->addItem(QString());
        preferSharpFlat->setObjectName(QString::fromUtf8("preferSharpFlat"));
        ...
        stringDataFrame->setObjectName(QString::fromUtf8("stringDataFrame"));
        ...
        labelNumOfStrings->setObjectName(QString::fromUtf8("labelNumOfStrings"));

        horizontalLayout_4->addWidget(labelNumOfStrings);

        numOfStrings = new QLabel(stringDataFrame);
        numOfStrings->setObjectName(QString::fromUtf8("numOfStrings"));

        horizontalLayout_4->addWidget(numOfStrings);

        editStringData = new QPushButton(stringDataFrame);
        editStringData->setObjectName(QString::fromUtf8("editStringData"));

        horizontalLayout_4->addWidget(editStringData);

        noReflectTranspositionInLinkedTab = new QCheckBox(stringDataFrame);
        noReflectTranspositionInLinkedTab->setObjectName(QString::fromUtf8("noReflectTranspositionInLinkedTab"));
        ...
        groupPrevNextButtons->setObjectName(QString::fromUtf8("groupPrevNextButtons"));
