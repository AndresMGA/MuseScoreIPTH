...
struct qt_meta_stringdata_mu__inspector__VerticalFrameSettingsModel_t {
    QByteArrayData data[9];
    char stringdata0[152];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__inspector__VerticalFrameSettingsModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__inspector__VerticalFrameSettingsModel_t qt_meta_stringdata_mu__inspector__VerticalFrameSettingsModel = {
    {
QT_MOC_LITERAL(0, 0, 41), // "mu::inspector::VerticalFrameS..."
QT_MOC_LITERAL(1, 42, 11), // "frameHeight"
QT_MOC_LITERAL(2, 54, 13), // "PropertyItem*"
QT_MOC_LITERAL(3, 68, 8), // "gapAbove"
QT_MOC_LITERAL(4, 77, 8), // "gapBelow"
QT_MOC_LITERAL(5, 86, 15), // "frameLeftMargin"
QT_MOC_LITERAL(6, 102, 16), // "frameRightMargin"
QT_MOC_LITERAL(7, 119, 14), // "frameTopMargin"
QT_MOC_LITERAL(8, 134, 17) // "frameBottomMargin"

    },
    "mu::inspector::VerticalFrameSettingsModel\0"
    "frameHeight\0PropertyItem*\0gapAbove\0"
    "gapBelow\0frameLeftMargin\0frameRightMargin\0"
    "frameTopMargin\0frameBottomMargin"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__inspector__VerticalFrameSettingsModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::inspector::VerticalFrameSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_mu__inspector__VerticalFrameSettingsModel.data,
    qt_meta_data_mu__inspector__VerticalFrameSettingsModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::inspector::VerticalFrameSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__inspector__VerticalFrameSettingsModel.stringdata0))
