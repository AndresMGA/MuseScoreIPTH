...
struct qt_meta_stringdata_mu__inspector__NotationSettingsProxyModel_t {
    QByteArrayData data[1];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__inspector__NotationSettingsProxyModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__inspector__NotationSettingsProxyModel_t qt_meta_stringdata_mu__inspector__NotationSettingsProxyModel = {
    {
QT_MOC_LITERAL(0, 0, 41) // "mu::inspector::NotationSettin..."
...
static const uint qt_meta_data_mu__inspector__NotationSettingsProxyModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::inspector::NotationSettingsProxyModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorProxyModel::staticMetaObject>(),
    qt_meta_stringdata_mu__inspector__NotationSettingsProxyModel.data,
    qt_meta_data_mu__inspector__NotationSettingsProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::inspector::NotationSettingsProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__inspector__NotationSettingsProxyModel.stringdata0))
