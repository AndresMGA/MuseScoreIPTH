...
struct qt_meta_stringdata_mu__inspector__GradualTempoChangePlaybackModel_t {
    QByteArrayData data[6];
    char stringdata0[120];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__inspector__GradualTempoChangePlaybackModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__inspector__GradualTempoChangePlaybackModel_t qt_meta_stringdata_mu__inspector__GradualTempoChangePlaybackModel = {
    {
QT_MOC_LITERAL(0, 0, 46), // "mu::inspector::GradualTempoCh..."
QT_MOC_LITERAL(1, 47, 21), // "possibleEasingMethods"
QT_MOC_LITERAL(2, 69, 0), // ""
QT_MOC_LITERAL(3, 70, 17), // "tempoChangeFactor"
QT_MOC_LITERAL(4, 88, 13), // "PropertyItem*"
QT_MOC_LITERAL(5, 102, 17) // "tempoEasingMethod"

    },
    "mu::inspector::GradualTempoChangePlaybackModel\0"
    "possibleEasingMethods\0\0tempoChangeFactor\0"
    "PropertyItem*\0tempoEasingMethod"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__inspector__GradualTempoChangePlaybackModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::inspector::GradualTempoChangePlaybackModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_mu__inspector__GradualTempoChangePlaybackModel.data,
    qt_meta_data_mu__inspector__GradualTempoChangePlaybackModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::inspector::GradualTempoChangePlaybackModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__inspector__GradualTempoChangePlaybackModel.stringdata0))
