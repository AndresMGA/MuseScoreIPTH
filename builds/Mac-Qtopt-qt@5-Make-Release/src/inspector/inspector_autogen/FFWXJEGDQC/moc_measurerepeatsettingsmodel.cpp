...
struct qt_meta_stringdata_mu__inspector__MeasureRepeatSettingsModel_t {
    QByteArrayData data[3];
    char stringdata0[71];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__inspector__MeasureRepeatSettingsModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__inspector__MeasureRepeatSettingsModel_t qt_meta_stringdata_mu__inspector__MeasureRepeatSettingsModel = {
    {
QT_MOC_LITERAL(0, 0, 41), // "mu::inspector::MeasureRepeatS..."
QT_MOC_LITERAL(1, 42, 14), // "numberPosition"
QT_MOC_LITERAL(2, 57, 13) // "PropertyItem*"

    },
    "mu::inspector::MeasureRepeatSettingsModel\0"
    "numberPosition\0PropertyItem*"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__inspector__MeasureRepeatSettingsModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::inspector::MeasureRepeatSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_mu__inspector__MeasureRepeatSettingsModel.data,
    qt_meta_data_mu__inspector__MeasureRepeatSettingsModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::inspector::MeasureRepeatSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__inspector__MeasureRepeatSettingsModel.stringdata0))
