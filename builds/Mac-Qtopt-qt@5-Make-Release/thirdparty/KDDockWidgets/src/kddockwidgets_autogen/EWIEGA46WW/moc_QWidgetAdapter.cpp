...
#include <memory>
#include "../../../../../../../thirdparty/KDDockWidgets/src/QWidgetAdapter.h"
...
struct qt_meta_stringdata_KDDockWidgets__LayoutGuestWidget_t {
    QByteArrayData data[1];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_KDDockWidgets__LayoutGuestWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_KDDockWidgets__LayoutGuestWidget_t qt_meta_stringdata_KDDockWidgets__LayoutGuestWidget = {
    {
QT_MOC_LITERAL(0, 0, 32) // "KDDockWidgets::LayoutGuestWidget"
...
static const uint qt_meta_data_KDDockWidgets__LayoutGuestWidget[] = {
...
QT_INIT_METAOBJECT const QMetaObject KDDockWidgets::LayoutGuestWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<KDDockWidgets::QWidgetAdapter::staticMetaObject>(),
    qt_meta_stringdata_KDDockWidgets__LayoutGuestWidget.data,
    qt_meta_data_KDDockWidgets__LayoutGuestWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *KDDockWidgets::LayoutGuestWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KDDockWidgets__LayoutGuestWidget.stringdata0))
