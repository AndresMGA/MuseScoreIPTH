...
struct qt_meta_stringdata_Layouting__RubberBand_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Layouting__RubberBand_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Layouting__RubberBand_t qt_meta_stringdata_Layouting__RubberBand = {
    {
QT_MOC_LITERAL(0, 0, 21) // "Layouting::RubberBand"
...
static const uint qt_meta_data_Layouting__RubberBand[] = {
...
QT_INIT_METAOBJECT const QMetaObject Layouting::RubberBand::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickItem::staticMetaObject>(),
    qt_meta_stringdata_Layouting__RubberBand.data,
    qt_meta_data_Layouting__RubberBand,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Layouting::RubberBand::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Layouting__RubberBand.stringdata0))
