...
struct qt_meta_stringdata_mu__inspector__ChordSettingsModel_t {
    QByteArrayData data[3];
    char stringdata0[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__inspector__ChordSettingsModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__inspector__ChordSettingsModel_t qt_meta_stringdata_mu__inspector__ChordSettingsModel = {
    {
QT_MOC_LITERAL(0, 0, 33), // "mu::inspector::ChordSettingsM..."
QT_MOC_LITERAL(1, 34, 10), // "isStemless"
QT_MOC_LITERAL(2, 45, 13) // "PropertyItem*"

    },
    "mu::inspector::ChordSettingsModel\0"
    "isStemless\0PropertyItem*"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__inspector__ChordSettingsModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::inspector::ChordSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInspectorModel::staticMetaObject>(),
    qt_meta_stringdata_mu__inspector__ChordSettingsModel.data,
    qt_meta_data_mu__inspector__ChordSettingsModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::inspector::ChordSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__inspector__ChordSettingsModel.stringdata0))
