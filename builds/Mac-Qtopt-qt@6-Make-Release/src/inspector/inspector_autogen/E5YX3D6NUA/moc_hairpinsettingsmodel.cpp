...
struct qt_meta_stringdata_mu__inspector__HairpinSettingsModel_t {
    QByteArrayData data[5];
    char stringdata0[96];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__inspector__HairpinSettingsModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__inspector__HairpinSettingsModel_t qt_meta_stringdata_mu__inspector__HairpinSettingsModel = {
    {
QT_MOC_LITERAL(0, 0, 35), // "mu::inspector::HairpinSetting..."
QT_MOC_LITERAL(1, 36, 21), // "isNienteCircleVisible"
QT_MOC_LITERAL(2, 58, 13), // "PropertyItem*"
QT_MOC_LITERAL(3, 72, 6), // "height"
QT_MOC_LITERAL(4, 79, 16) // "continuousHeight"

    },
    "mu::inspector::HairpinSettingsModel\0"
    "isNienteCircleVisible\0PropertyItem*\0"
    "height\0continuousHeight"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__inspector__HairpinSettingsModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::inspector::HairpinSettingsModel::staticMetaObject = { {
    QMetaObject::SuperData::link<TextLineSettingsModel::staticMetaObject>(),
    qt_meta_stringdata_mu__inspector__HairpinSettingsModel.data,
    qt_meta_data_mu__inspector__HairpinSettingsModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::inspector::HairpinSettingsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__inspector__HairpinSettingsModel.stringdata0))
