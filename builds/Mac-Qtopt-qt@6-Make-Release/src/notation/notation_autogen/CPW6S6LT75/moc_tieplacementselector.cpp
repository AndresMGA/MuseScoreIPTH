...
struct qt_meta_stringdata_mu__notation__TiePlacementSelectorModel_t {
    QByteArrayData data[4];
    char stringdata0[88];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__notation__TiePlacementSelectorModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__notation__TiePlacementSelectorModel_t qt_meta_stringdata_mu__notation__TiePlacementSelectorModel = {
    {
QT_MOC_LITERAL(0, 0, 39), // "mu::notation::TiePlacementSel..."
QT_MOC_LITERAL(1, 40, 20), // "placementSingleNotes"
QT_MOC_LITERAL(2, 61, 10), // "StyleItem*"
QT_MOC_LITERAL(3, 72, 15) // "placementChords"

    },
    "mu::notation::TiePlacementSelectorModel\0"
    "placementSingleNotes\0StyleItem*\0"
    "placementChords"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__notation__TiePlacementSelectorModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::notation::TiePlacementSelectorModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractStyleDialogModel::staticMetaObject>(),
    qt_meta_stringdata_mu__notation__TiePlacementSelectorModel.data,
    qt_meta_data_mu__notation__TiePlacementSelectorModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::notation::TiePlacementSelectorModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__notation__TiePlacementSelectorModel.stringdata0))
