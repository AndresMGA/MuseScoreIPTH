...
struct qt_meta_stringdata_mu__notation__NotesPageModel_t {
    QByteArrayData data[3];
    char stringdata0[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__notation__NotesPageModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__notation__NotesPageModel_t qt_meta_stringdata_mu__notation__NotesPageModel = {
    {
QT_MOC_LITERAL(0, 0, 28), // "mu::notation::NotesPageModel"
QT_MOC_LITERAL(1, 29, 20), // "useStraightNoteFlags"
QT_MOC_LITERAL(2, 50, 10) // "StyleItem*"

    },
    "mu::notation::NotesPageModel\0"
    "useStraightNoteFlags\0StyleItem*"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_mu__notation__NotesPageModel[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::notation::NotesPageModel::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractStyleDialogModel::staticMetaObject>(),
    qt_meta_stringdata_mu__notation__NotesPageModel.data,
    qt_meta_data_mu__notation__NotesPageModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::notation::NotesPageModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__notation__NotesPageModel.stringdata0))
