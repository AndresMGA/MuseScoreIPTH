...
struct qt_meta_stringdata_mu__instrumentsscene__StaffTreeItem_t {
    QByteArrayData data[1];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_mu__instrumentsscene__StaffTreeItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_mu__instrumentsscene__StaffTreeItem_t qt_meta_stringdata_mu__instrumentsscene__StaffTreeItem = {
    {
QT_MOC_LITERAL(0, 0, 35) // "mu::instrumentsscene::StaffTr..."
...
static const uint qt_meta_data_mu__instrumentsscene__StaffTreeItem[] = {
...
QT_INIT_METAOBJECT const QMetaObject mu::instrumentsscene::StaffTreeItem::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractInstrumentsPanelTreeItem::staticMetaObject>(),
    qt_meta_stringdata_mu__instrumentsscene__StaffTreeItem.data,
    qt_meta_data_mu__instrumentsscene__StaffTreeItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *mu::instrumentsscene::StaffTreeItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_mu__instrumentsscene__StaffTreeItem.stringdata0))
