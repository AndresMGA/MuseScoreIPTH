...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/Users/andresgarcia/MuseScore/builds/Mac-Qtopt-qt@6-Make-Release/install/mscore.app")
  ...
  file(INSTALL DESTINATION "/Users/andresgarcia/MuseScore/builds/Mac-Qtopt-qt@6-Make-Release/install" TYPE DIRECTORY FILES "/Users/andresgarcia/MuseScore/builds/Mac-Qtopt-qt@6-Make-Release/src/app/mscore.app" USE_SOURCE_PERMISSIONS)
  if(EXISTS "$ENV{DESTDIR}/Users/andresgarcia/MuseScore/builds/Mac-Qtopt-qt@6-Make-Release/install/mscore.app/Contents/MacOS/mscore" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/Users/andresgarcia/MuseScore/builds/Mac-Qtopt-qt@6-Make-Release/install/mscore.app/Contents/MacOS/mscore")
    execute_process(COMMAND /usr/bin/install_name_tool
      -add_rpath "/usr/local/lib"
      "$ENV{DESTDIR}/Users/andresgarcia/MuseScore/builds/Mac-Qtopt-qt@6-Make-Release/install/mscore.app/Contents/MacOS/mscore")
  endif()
endif()
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/mscore.app/Contents/Resources/fonts" TYPE FILE FILES
    ...
    "/Users/andresgarcia/MuseScore/fonts/mscore/MusescoreIcon.ttf"
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/mscore.app/Contents/Resources/Frameworks/" TYPE DIRECTORY FILES "/usr/local/share/qt/qml" REGEX ".*qtwebkit.*" EXCLUDE REGEX ".*qttest.*" EXCLUDE REGEX ".*qtsensors.*" EXCLUDE REGEX ".*qtmultimedia.*" EXCLUDE REGEX ".*qtaudioengine.*" EXCLUDE REGEX ".*_debug\\.dylib" EXCLUDE)
endif()
